...
LSG Track is a GIS-powered **Decision Support System (DSS)** designed for Kerala Local Self Government Institutions (LSGs) to help Panchayat Secretaries monitor trade license compliance, prioritize inspections, and make faster, data-driven administrative decisions.

> [!IMPORTANT]
> **LSG Track is NOT an ERP and DOES NOT replace K-SMART.**
>
> **K-SMART** remains the official Government ERP responsible for:
...
>
> LSG Track functions as a **Decision Support Layer**, transforming synchronized K-SMART trade license data into actionable GIS intelligence, compliance analytics, and operational dashboards.

---

# Problem Statement

K-SMART efficiently manages trade licenses and official workflows. However, Panchayat Secretaries often require a faster operational view of:

- Businesses requiring inspection
- Expired or expiring licenses
- Ward-wise compliance
- Revenue leakage risks
- Geographic distribution of licensed establishments

Reviewing these insights directly from administrative records can be time-consuming.

LSG Track bridges this gap by converting synchronized K-SMART trade license data into an interactive GIS-powered monitoring platform that supports faster and more informed administrative decision-making.

---

# Objectives

- Improve trade license compliance monitoring
- Reduce inspection planning time
- Visualize businesses on an interactive GIS map
- Identify suspected unlicensed establishments
- Reduce potential revenue leakage
- Improve accessibility for government officers
...
```text
        ...
        Single Source of Truth for Licenses & Permits
                               │
                               ▼
                    CSV / Excel Export (DEO)
                               │
                               ▼
                 Validation & Synchronization Engine
                               │
                               ▼
